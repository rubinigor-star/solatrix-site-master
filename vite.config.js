...
const HERO_PREVIEW_MARKUP = `
  <div class="hero-preview-card" aria-label="הדגמת מערכת סולארית ביתית של 22.5 קילוואט">
...
.hero-preview-photo{position:absolute;left:18px;right:18px;top:68px;bottom:112px;border-radius:20px;background-image:linear-gradient(180deg,rgba(3,18,29,.03),rgba(3,18,29,.16)),url('./assets/hero/igor-hero.png');background-size:cover;background-position:center;box-shadow:inset 0 0 70px rgba(2,13,20,.2)}
