...
.hero-preview-scan{position:absolute;z-index:8;top:68px;bottom:112px;left:78%;width:3px;background:linear-gradient(180deg,transparent,#ffd45c 12%,#fff2b4 50%,#ffd45c 88%,transparent);box-shadow:0 0 14px #ffd45c,0 0 32px rgba(255,212,92,.58);animation:igorScan 7s ease-in-out infinite;pointer-events:none}
@keyframes igorScan{0%,100%{left:78%}50%{left:22%}}
